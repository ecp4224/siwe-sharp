...
{
  sealed public class Rule_sign_in_with_ethereum:Rule
  {
    ...
    public static Rule_sign_in_with_ethereum Parse(ParserContext context)
    {
      ...
      parsed = false;
      {
        ...
        if (parsed)
        {
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            rule = Terminal_StringValue.Parse(context, " wants you to sign in with your Ethereum account:");
            if ((f1 = rule != null))
            {
              a1.Add(rule, context.index);
              c1++;
        ...
        if (parsed)
        {
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            rule = Terminal_StringValue.Parse(context, "Version: ");
            if ((f1 = rule != null))
            {
              a1.Add(rule, context.index);
              c1++;
        ...
        if (parsed)
        {
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            rule = Terminal_StringValue.Parse(context, "Chain ID: ");
            if ((f1 = rule != null))
            {
              a1.Add(rule, context.index);
              c1++;
        ...
        if (parsed)
        {
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            rule = Terminal_StringValue.Parse(context, "Nonce: ");
            if ((f1 = rule != null))
            {
              a1.Add(rule, context.index);
              c1++;
        ...
        if (parsed)
        {
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            rule = Terminal_StringValue.Parse(context, "Issued At: ");
            if ((f1 = rule != null))
            {
              a1.Add(rule, context.index);
              c1++;
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            ...
            parsed = false;
            {
              ...
              if (parsed)
              {
                ...
                for (int i2 = 0; i2 < 1 && f2; i2++)
                {
                  rule = Terminal_StringValue.Parse(context, "Expiration Time: ");
                  if ((f2 = rule != null))
                  {
                    a2.Add(rule, context.index);
                    c2++;
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            ...
            parsed = false;
            {
              ...
              if (parsed)
              {
                ...
                for (int i2 = 0; i2 < 1 && f2; i2++)
                {
                  rule = Terminal_StringValue.Parse(context, "Not Before: ");
                  if ((f2 = rule != null))
                  {
                    a2.Add(rule, context.index);
                    c2++;
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            ...
            parsed = false;
            {
              ...
              if (parsed)
              {
                ...
                for (int i2 = 0; i2 < 1 && f2; i2++)
                {
                  rule = Terminal_StringValue.Parse(context, "Request ID: ");
                  if ((f2 = rule != null))
                  {
                    a2.Add(rule, context.index);
                    c2++;
          ...
          for (int i1 = 0; i1 < 1 && f1; i1++)
          {
            ...
            parsed = false;
            {
              ...
              if (parsed)
              {
                ...
                for (int i2 = 0; i2 < 1 && f2; i2++)
                {
                  rule = Terminal_StringValue.Parse(context, "Resources:");
                  if ((f2 = rule != null))
                  {
                    a2.Add(rule, context.index);
                    c2++;
